...
function! s:light() abort
  ...
  let pink         = {'gui': '#e16183', 'cterm': '204'}
  let orange       = {'gui': '#e5822a', 'cterm': '208'}
  let blue         = {'gui': '#58aef6', 'cterm': '75'}
  let gray         = {'gui': '#c4c9cc', 'cterm': '252'}
  let red          = {'gui': '#e21f1f', 'cterm': '196'}
  let yellow       = {'gui': '#d7b402', 'cterm': '178'}
  let green        = {'gui': '#a8d670', 'cterm': '76'}
  let lightpurple  = {'gui': '#f2dbfa', 'cterm': '189'}
  let lightpink    = {'gui': '#feecef', 'cterm': '225'}
  let lightorange  = {'gui': '#f8e2ce', 'cterm': '223'}
  let lightblue    = {'gui': '#e2f1fd', 'cterm': '195'}
  let lightgray    = {'gui': '#e7e9e9', 'cterm': '254'}
  let lightred     = {'gui': '#fbdada', 'cterm': '224'}
  let lightyellow  = {'gui': '#faf4d1', 'cterm': '230'}
  let lightgreen   = {'gui': '#e5f7cf', 'cterm': '193'}
